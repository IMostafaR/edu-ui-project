    ...
    <>
      <section className="container pt-120">
        <div className="teacher-details d-flex gap-3 mt-5">
          <div className="image">
            <Image src={images.teachers.teacherOne} alt="" />
          </div>
          ...
          <div className="container">
            <div className="content">
              <div className="box box-shadow box-radius">
                <div className="image">
                  <Link href="/course-details">
                    <Image src={images.pageSix.fCourseOne} alt="course" />
                  </Link>
                </div>
                ...
                <div className="author">
                  <Image src={images.pageSix.authorOne} alt="author" />
                  <p>
              ...
              <div className="box box-shadow box-radius">
                <div className="image">
                  <Link href="/course-details">
                    <Image src={images.pageSix.fCourseTwo} alt="course" />
                  </Link>
                </div>
                <div className="reviews">
                  <div className="star d-flex gap-1">
                ...
                <div className="author">
                  <Image src={images.pageSix.authorTwo} alt="author" />
                  <p>
              ...
              <div className="box box-shadow box-radius">
                <div className="image">
                  <Link href="/course-details">
                    <Image src={images.pageSix.fCourseThree} alt="course" />
                  </Link>
                </div>
                <div className="reviews">
                  <div className="star d-flex gap-1">
                ...
                <div className="author">
                  <Image src={images.pageSix.authorThree} alt="author" />
                  <p>
