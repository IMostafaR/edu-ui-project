            ...
            <div className="row justify-content-between">
              ...
              <div className="col-12 col-sm-6 col-lg-2 mb-5">
                <div className="content">
                  ...
                  <nav className="nav flex-column">
                    <Link className="nav-link tx-gray" href="about">
                      About Eduan{" "}
                    </Link>
                    <Link className="nav-link tx-gray" href="contact">
                      Contact{" "}
                    </Link>
                    <Link className="nav-link tx-gray" href="contact">
                      Help Centre
                    </Link>
                    <Link className="nav-link tx-gray" href="price">
                      Refund
                    </Link>
                    <Link className="nav-link tx-gray" href="blog">
                      Conditions
                    </Link>
                    <Link className="nav-link tx-gray" href="course">
                      Privacy Policy
                    </Link>
                  </nav>
                </div>
              ...
              <div className="col-12 col-sm-6 col-lg-2 mb-5">
                <div className="content">
                  <h4>Categories</h4>
                  <nav className="nav flex-column">
                    <Link className="nav-link tx-gray" href="course-details">
                      Design Skills
                    </Link>
                    <Link className="nav-link tx-gray" href="course-details">
                      Development
