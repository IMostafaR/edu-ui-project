        ...
        <div className="row align-items-center">
          <div className="col-lg-6">
            <div className="content mb-5 mb-lg-auto">
              <span
                className="bg-light-red py-1 px-4 tx-red fw-bold mb-3 d-inline-block"
    ...
    <section className="pt-120 mb-5">
      <div className="container">
        ...
        <div className="row">
          <div className="col">
            <div
              className="companies d-flex justify-content-evenly align-content-center gap-5 flex-wrap border border-1 py-4"
            >
              <img
        ...
        <div className="row">
          <div className="col">
            <div className="title d-flex flex-column align-items-center">
              <span
                className="f-courses bg-light-red py-1 px-4 tx-red fw-bold mb-3 d-inline-block"
                >Featured Courses
              </span>
              <h1 className="tx-black fw-bold mb-5">Explore Featured Courses</h1>
            </div>
            <div className="card text-center mb-5 w-50 m-auto rounded-5">
              <div className="">
                <ul
                  className="nav nav-tabs card-header-tabs p-2 d-flex justify-content-between"
                >
        ...
        <div className="row row-cols-1 row-cols-md-4 g-4">
          <div className="col">
            <div className="card h-100 box-radius border-0 shadow-lg p-2">
              ...
              <div
                className="card-footer bg-white d-flex justify-content-between justify-content-center pt-3"
              >
      ...
      <div className="container">
        <div className="row align-items-center g-3">
          ...
          <div className="col-lg-6">
            <div className="mt-5">
              <span
                className="bg-light-red py-1 px-4 tx-red fw-bold mb-3 d-inline-block free"
                >Download App</span
              >
    ...
    <section className="pt-120 events f-courses bg-purple">
      <div className="container">
        <div className="row">
          <div className="col">
            <div
              className="d-flex justify-content-between gap-2 align-content-center"
            >
              <div>
                <span
                  className="events bg-light-red py-1 px-4 tx-red fw-bold mb-3 d-inline-block"
            ...
            <div className="card h-100 box-radius box-shadow p-3">
              ...
              <div className="card-body p-4">
                <span className="pe-3 tx-gray"
                  ><i className="fa-solid fa-location-dot pe-2 tx-red"></i>London,
                  US</span
                ><span className="tx-gray"
                  ><i className="fa-regular fa-clock pe-2 tx-red"></i>8.00 am - 6.00
                  pm</span
                >
        ...
        <div className="row">
          <div className="col">
            <div className="title d-flex flex-column align-items-center mb-5">
              <span
                className="our-blog bg-light-red py-1 px-4 tx-red fw-bold mb-3 d-inline-block"
                >Student Reviews
              </span>
              <h2 className="tx-black fw-bold mb-5">What Our Students Saying</h2>
        ...
        <div className="row row-cols-1 row-cols-md-3 g-4">
          <div className="col">
            <div className="card bg-gray border-0 box-radius p-3">
              <div className="card-body">
                <div
                  className="d-flex justify-content-between align-items-center gap-1 mb-5"
                >
                  <div
      ...
      <div className="container">
        ...
        <div className="row align-items-center justify-content-center">
          <div className="col-lg-8">
            <div
              className="card mb-3 p-2 box-shadow align-items-stretch box-radius border-0"
            >
              <div className="row g-4 align-items-center">
                ...
                <div className="col-md-8">
                  <div className="card-body">
                    <span className="pe-3 tx-gray"
                      ><i className="fa-regular fa-user pe-2 tx-red"></i>Admin</span
                    ><span className="tx-gray"
